...
export default function NovaObraSimple() {
  ...
  }, [user?.jwtUser?.companyId])

  const loadClientes = async () => {
    try {
      const clientesData = await getClientesSimples(user!.jwtUser!.companyId!)
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      const obraData: ObraInsertData = {
        company_id: user.jwtUser.companyId,
