...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError('Test case failed: The daily progress report submission did not succeed as expected. The report was not saved or displayed in the daily reports list.')
