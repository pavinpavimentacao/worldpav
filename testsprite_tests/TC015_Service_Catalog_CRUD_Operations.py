...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError('Test case failed: The test plan for validating creation, update, listing, and deletion of paving services did not complete successfully.')
