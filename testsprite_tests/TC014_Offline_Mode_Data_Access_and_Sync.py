...
async def run_test():
    ...
    try:
        ...
        try:
            ...
            raise AssertionError('Test plan failed: PWA offline capabilities verification failed. The test could not confirm offline data access, queuing of changes, or successful sync after reconnection.')
